state("fceux")
{
	...
	byte BossHP:		0x3B1388, 0x05E0;
	byte BossHP2:		0x3B1388, 0x05E1;
	byte BossMachine:	0x3B1388, 0x05E3;
...
state("nestopia")
{
	...
	byte BossHP:		"nestopia.exe", 0x1b2bcc, 0, 8, 0xc, 0xc, 0x648;
	byte BossHP2:		"nestopia.exe", 0x1b2bcc, 0, 8, 0xc, 0xc, 0x649;
	byte BossMachine:	"nestopia.exe", 0x1b2bcc, 0, 8, 0xc, 0xc, 0x64B;
...
split
{
	...
	if (settings["lvl13"] && current.Level == 4 && old.BossHP == 0 && current.BossHP == 0xFF) return true;
	...
	if (settings["lvl24"] && current.Level == 12 && old.BossMachine == 0 && current.BossMachine == 0xFE) return true;
	...
	if (settings["lvl34"] && current.Level == 20 && old.BossHP == 0 && current.BossHP == 0xFF) return true;
	...
	if (settings["lvl44"] && current.Level == 28 &&
		(((old.BossHP > 0x40) && (old.BossHP2 == 0 && current.BossHP2 == 0xFE)) ||
		((old.BossHP2 > 0x40) && (old.BossHP == 0 && current.BossHP == 0xFE))))
		return true;
		
	if (settings["lvl51"] && current.Level == 30 && old.EndStage == 0x12 && current.EndStage == 0x02) return true;
	if (settings["lvl52"] && current.Level == 32 && old.BossHP == 0 && current.BossHP == 0xFF) return true;
